...
class AES:
    ...
    def MixColumns(self, matrix):
        ...
        for i in range(Nb):
            n[i][0] = (self.multiplication_table2[matrix[i][0]] ^ self.multiplication_table3[matrix[i][1]]
                    ^ matrix[i][2] ^ matrix[i][3])
            n[i][1] = (matrix[i][0] ^ self.multiplication_table2[matrix[i][1]]
                    ^ self.multiplication_table3[matrix[i][2]] ^ matrix[i][3])
            n[i][2] = (matrix[i][0] ^ matrix[i][1]
                    ^ self.multiplication_table2[matrix[i][2]] ^ self.multiplication_table3[matrix[i][3]])
            n[i][3] = (self.multiplication_table3[matrix[i][0]] ^ matrix[i][1]
                    ^ matrix[i][2] ^ self.multiplication_table2[matrix[i][3]])
    ...
    def InverseMixColumns(self, matrix):
        ...
        for i in range(Nb):
            n[i][0] = (self.multiplication_table14[matrix[i][0]] ^ self.multiplication_table11[matrix[i][1]]
                    ^ self.multiplication_table13[matrix[i][2]] ^ self.multiplication_table9[matrix[i][3]])
            n[i][1] = (self.multiplication_table9[matrix[i][0]] ^ self.multiplication_table14[matrix[i][1]]
                    ^ self.multiplication_table11[matrix[i][2]] ^ self.multiplication_table13[matrix[i][3]])
            n[i][2] = (self.multiplication_table13[matrix[i][0]] ^ self.multiplication_table9[matrix[i][1]]
                    ^ self.multiplication_table14[matrix[i][2]] ^ self.multiplication_table11[matrix[i][3]])
            n[i][3] = (self.multiplication_table11[matrix[i][0]] ^ self.multiplication_table13[matrix[i][1]]
                    ^ self.multiplication_table9[matrix[i][2]] ^ self.multiplication_table14[matrix[i][3]])
